    ...
    <ul class="user-items-title">
        <li><a href="admin/calculations" class="user-item-title" style="pointer-events: none; color: gray; border-color: gray">Vyúčtování</a></li>
        <li><a href="admin/landlords" class="user-item-title" style="pointer-events: none; color: gray; border-color: gray">Pronajímatele</a></li>
