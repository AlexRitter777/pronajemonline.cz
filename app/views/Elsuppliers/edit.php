...
<div class="table-container entity-table">
    ...
    <form method="post" name="elsupplier" action="elsuppliers/<?=$elsupplier->id;?>/update" data-type="classic">
            ...
            <tr class="">
                ...
                <td class="col-2">
                    <input
                        ...
                        value="<?= $old['elsupplier_name'] ?? $elsupplier->name;?>"
                    >
                </td>
            </tr>
            <tr class="">
                ...
                <td class="col-2">
                    <input
                        ...
                        data-lang="Informace"
                        value="<?= $old['elsupplier_add_info'] ?? $elsupplier->add_info;?>"
                    >
                </td>
            </tr>
        ...
        <div class="submit_button_div">
            ...
            <a class="form-btn btn-reset" href="elsuppliers/<?=$elsupplier->id;?>">Zpět</a>
        </div>
    </form>
