<div id="modal-opacity">
    ...
    <div class="central-bar">
        <form method="post" class='modal_window_form entity-modal-form' name="landlord" data-type="modal" action="">
            ...
            <div class="modal_buttons">
                <input type="submit" class="form-btn btn-submit" id="new-property" value="Uložit">
