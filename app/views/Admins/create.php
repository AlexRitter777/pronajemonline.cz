...
<div class="table-container entity-table">
    <form method="post" name="admin" action="admins/store" data-type="classic">
        ...
        <div class="submit_button_div">
            ...
            <a class="form-btn btn-reset" href="admins">Zpět</a>
        </div>
    </form>
</div>
