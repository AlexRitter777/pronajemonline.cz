...
<svg style="display:none;">
    ...
    <div class="main-container">
        ...
        <form method="POST" class="form calculation-form" action="/applications/total-calc" name="total">

            <?php require_once APP . "/views/Includes/common_calc_data.php"; ?>

            <div class="form-deposit-items-group">
                <h2 class="calculation-title">IV. Položky vyúčtování </h2>
                ...
                <a href="#" class="add_input_fields_deposit_items_button" style="display: none;">
                    ...
                    <span class="icon_title">Přidat řádek</span>
                </a>
            </div>
