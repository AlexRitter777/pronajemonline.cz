...
<div class="user-header">
    ...
    <div class="central-bar">
        ...
        <?php if($tenants): ?>
        <table class="tenant-titles account-index-table user-tenants-table" border="0">
            <tr class="row-1">
            ...
            <tr class="row-click" data-href="user/tenants/profile?tenant_id=<?=$tenant->id;?>">
        ...
        <a class="new-item-btn" href="user/tenants/add">Nový nájemník</a>
    </div>


    <div id="del-conf" class="modal_del_confirmation">
        <div class="small_modal_wrapper">
            <div><span class="modal_confirm_btn" data-href="user/tenants/profile-delete?tenant_id=">Smazat</span></div>
