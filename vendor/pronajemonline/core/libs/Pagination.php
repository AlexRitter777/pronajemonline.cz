...
/**
 * Pagination class handles the logic of dividing content into discrete pages
 * and generating navigation links to browse through these pages.
 */
class Pagination
{
    ...
    /**
     * Constructs the Pagination object with initial settings.
     *
    ...
    /**
     * Determines the current page number, ensuring it's within valid range.
     *
